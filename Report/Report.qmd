...
-   Primary keys are underlined whereas foreign keys ar double underlined.

-   The primary key of the weak side become the foreign key on the strong side of the cardinality.

-   Composite attributes (customer name, customer and seller address, product price and advertisement budget ) are registered in individual fields using outer layer of the attriubte to ensure that physical database only capture atomic value.
...
-   The ternary M:N relationship among Customers, Products and Ships is converted into the Orders table

[**Will add code chunks of table creation here**]{.underline}
