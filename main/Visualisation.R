...
SELECT o.id, o.customer_id, o.product_id, o.quantity, o.discount, o.order_date, COALESCE(o.rating_review,0) as rating_review, dfp.price,
...
g1 <- grid.arrange(figure.1, figure.2, figure.3, figure.4, nrow = 2,
